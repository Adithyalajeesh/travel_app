...
class KayakingPage extends StatefulWidget {
  const KayakingPage({super.key});

  @override
  State<KayakingPage> createState() => _DetailPageState();
}

class _DetailPageState extends State<KayakingPage> {
  int gottenStars=3;
  int selectedIndex=-1;
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          AppLargeText(
                            text: "Kayaking",color: Colors.black.withOpacity(0.8),),
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 5,),
                          AppText(text: "Zanskar, Ladakh",color: AppColors.textColor1,)
                        ],
                      ),
                      SizedBox(height: 6,),
                      Row(
                      ...
                      SizedBox(height: 8,),
                      AppText(text: "Adventurous paddling through scenic waterways ",
