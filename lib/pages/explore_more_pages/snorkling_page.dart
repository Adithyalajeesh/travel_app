...
class SnorklingPage extends StatefulWidget {
  const SnorklingPage({super.key});

  @override
  State<SnorklingPage> createState() => _DetailPageState();
}

class _DetailPageState extends State<SnorklingPage> {
  int gottenStars=3;
  int selectedIndex=-1;
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          AppLargeText(
                            text: "Snorkeling",color: Colors.black.withOpacity(0.8),),
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 5,),
                          AppText(text: "Baa Atoll, Maldives.",color: AppColors.textColor1,)
                        ],
                      ),
                      SizedBox(height: 6,),
                      Row(
                      ...
                      SizedBox(height: 8,),
                      AppText(text: " Snorkeling helps to explore vibrant marine life in crystal waters",
